...
DESCRIPTION = metadata.get('description', 'Test Run Project for Cookie Cutter Data Science')
AUTHOR = metadata.get('author', 'Dilip Albert')
AUTHOR_EMAIL = metadata.get('author_email', 'dilip_albert_datascientist@outlook.com')
