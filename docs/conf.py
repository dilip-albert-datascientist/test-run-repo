...
# -*- coding: utf-8 -*-
#
# test-run-project documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'test-run-repodoc'
...
texinfo_documents = [
    ('index', 'test-run-repo', u'test-run-project Documentation',
     u"Dilip Albert", 'test-run-project',
     'Test Run Project for Cookie Cutter Data Science', 'Miscellaneous'),
]
